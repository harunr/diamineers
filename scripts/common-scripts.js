...
;(function($){
	$(function(){
        ...
        $('#directory-content #tab > li').eq(0).addClass('active')
        $('#directory-content #tab-content-wrap div.tab-content').hide()
        $('#directory-content #tab-content-wrap div.tab-content').eq(0).show()
        
        $('#directory-content #tab > li').each(function(i){
            $(this).click(function(){
                
                if( $(this).hasClass('active') ) return false
                
                else{
                    $('#directory-content #tab > li').removeClass('active')
                    $(this).addClass('active')
                    $('#directory-content #tab-content-wrap div.tab-content').hide()
                    $('#directory-content #tab-content-wrap div.tab-content').eq(i).show()
                }
            })
        })
